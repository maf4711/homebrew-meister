...
#  - meister updates [--scan|--apply|--json]: brew, mas, macOS, Sparkle,
...
if [ "${1:-}" = "updates" ] || [ "${1:-}" = "appupdates" ] || [ "${1:-}" = "macupdate" ]; then
    echo -e "\033[1;34m  Meister UPDATES — alle Softwarestände\033[0m"
    echo ""
...
SYSTEM:
  ...
  meister updates [--apply|--json|--dry-run]
  ...
  meister appupdates   Alias for updates (scan)
