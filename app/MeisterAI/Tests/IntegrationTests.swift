...
final class IntegrationTests: XCTestCase {
    ...
    func testExecutionPlanKeepsPlannedModulesSeparateFromFindings() throws {
        let data = Data(#"{"schema":"meister.last/v1","ts":"2026-09-14T12:00:00Z","profile":"quick","twin":"MeisterAI","status":"completed","dry_run":true,"report_kind":"execution_plan","planned_modules":["Homebrew","Cleanup"],"fix":0,"warn":0,"err":0,"verified_repair_count":0,"score":null,"freed_bytes":null}"#.utf8)
    ...
    func testCLIReportReachesDashboardAndSiri() async throws {
        ...
        let evidence = repositoryRoot.appendingPathComponent("app/MeisterAI/build/verification")
