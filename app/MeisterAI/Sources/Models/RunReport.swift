...
struct RunReport: Decodable, Equatable, Identifiable, Sendable {
    ...
    init(from decoder: Decoder) throws {
        ...
        let storedTwin = try values.decodeIfPresent(String.self, forKey: .twin) ?? "meister"
        // Historical Apple-backed runs belong to the renamed app, not the Ollama twin.
        twin = storedTwin == "meisterSiri" || storedTwin == "MeisterSiri" ? "MeisterAI" : storedTwin
