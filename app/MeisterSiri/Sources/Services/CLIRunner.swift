...
final class CLIRunner: ObservableObject {
    ...
    var executionMessage: String {
        ...
        case .requiresUpdate: return "Die installierte CLI muss für die sichere App-Ausführung aktualisiert werden. Bitte meisterSiri aktualisieren; es wurde nichts gestartet."
        case .unavailable: return "meisterSiri nicht gefunden. Installiere: brew install maf4711/meister/meister"
        }
    }
