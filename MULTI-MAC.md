...
| | |
|---|---|
| GitHub | `maf4711/homebrew-meister` |
| SSH | `git@github.com:maf4711/homebrew-meister.git` |
| Remote dieses Checkouts | `git@github.com:maf4711/homebrew-meister.git` |
| Ordner | `~/Developer/homebrew-meister` |
| Default-Branch | `main` |

### Release

- Homebrew: im Repo-Root `./release.sh`. Das Skript liest die Version aus der Quelle, legt den GitHub-Release-Tag an, pusht `main` und installiert die Formula lokal. Ein schon veröffentlichter Tag bleibt liegen; dafür zuerst die Version erhöhen. `cpr` ohne Versionsbump pusht den Branch und schneidet keinen neuen Tag.
...
3. Dieser Checkout liegt danach unter `~/Developer/homebrew-meister`. Weicht der Ordner vom Repo-Namen ab, weil zwei Orgs denselben Namen haben, heißt er `~/Developer/<owner>--<name>`.
